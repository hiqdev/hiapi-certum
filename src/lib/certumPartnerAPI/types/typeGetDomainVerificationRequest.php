...
/*
<xs:complexType name="getDomainVerificationRequest">
	<xs:complexContent>
...
/**
 * This class represents the getDomainVerificationRequest WSDL type.
 *
 * It is an extension to the PartnerAPITypeRequest class.
 * 
 * @method PartnerAPITypeGetDomainVerificationRequest setOrderID(string $value) Sets the orderID element.
 * @method string getOrderID() Gets the orderID element.
 * @property string $orderID Gets the orderID element.
 * 
 * @method PartnerAPITypeGetDomainVerificationRequest setShowArchived(boolean $value) Sets the showArchived element.
 ...
 * @package types
 */
class PartnerAPITypeGetDomainVerificationRequest extends PartnerAPITypeRequest {
